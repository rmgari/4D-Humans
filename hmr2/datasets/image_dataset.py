...
class ImageDataset(Dataset):
    ...
    def process_webdataset_tar_item(item, train, 
        ...
        center_left, scale_left = data['center_left_hand'], data['scale_left_hand']
        center_right, scale_right = data['center_right_hand'], data['scale_right_hand']
        ...
        bbox_right_size = expand_to_aspect_ratio(scale_right*200, target_aspect_ratio=BBOX_SHAPE).max()

        center_left_x = center_left[0]
        center_left_y = center_left[1]
        bbox_left_size = expand_to_aspect_ratio(scale_left*200, target_aspect_ratio=BBOX_SHAPE).max()                
        ...
        img_patch_rgba, img_patch_right_rgba, img_patch_left_rgba, keypoints_2d, keypoints_2d_right_hand, keypoints_2d_left_hand, keypoints_2d_right_hand_bounding_box, keypoints_2d_left_hand_bounding_box, keypoints_3d, smplh_params, has_smplh_params, img_size, trans, trans_right, trans_left = get_example(img_rgba,
                                                                                                    center_x, center_y,
                                                                                                    center_right_x, center_right_y,
                                                                                                    center_left_x, center_left_y,
                                                                                                    bbox_size, bbox_size,
                                                                                                    bbox_right_size, bbox_right_size,
                                                                                                    bbox_left_size, bbox_left_size,
        ...
        img_patch_right = img_patch_right_rgba[:3,:,:]
        img_patch_left = img_patch_left_rgba[:3,:,:]
        ...
        item['keypoints_2d_right_hand_bounding_box'] = keypoints_2d_right_hand_bounding_box.astype(np.float32)
        item['keypoints_2d_left_hand_bounding_box'] = keypoints_2d_left_hand_bounding_box.astype(np.float32)        
        item['keypoints_3d'] = keypoints_3d.astype(np.float32)
        item['orig_keypoints_2d'] = orig_keypoints_2d
        ...
        item['_scale'] = scale
        item['_trans'] = trans
        item['_trans_right'] = trans_right
        item['_trans_left'] = trans_left          
        item['imgname'] = key
        # item['idx'] = idx
        return item
